...
var keyOwners = map[string]string{
	...
	"issue.editField":         issue.ViewID,
	"issue.save":              issue.ViewID,
	"issue.undoAll":           issue.ViewID,
	"issue.assign":            issue.ViewID,
	...
	"issue.copyKey":           issue.ViewID,
	"issue.copyLink":          issue.ViewID,
	"issue.openBrowser":       issue.ViewID,
	...
	"backlog.rank-up":     backlog.ViewID,
	"backlog.rank-down":   backlog.ViewID,
	"backlog.rank-top":    backlog.ViewID,
	...
	"board.rank-up":     board.ViewID,
	"board.rank-down":   board.ViewID,
	"board.rank-top":    board.ViewID,
	"board.rank-bottom": board.ViewID,
	"board.shift-left":  board.ViewID,
